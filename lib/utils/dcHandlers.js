...
// Command Executor
const commandExecuterFile = path.resolve(__dirname, '../templates/executor/message.js');
...
async function commandExecuter() {
	...
	fs.appendFileSync('./src/events/executor/message.js', data, { encoding: 'utf8' });
}
...
// const loadMainEnvFile = path.resolve(__dirname, '../templates/client/BotEnv.js');
// async function botEnvFile
